"""
This code is adapted from the Minkowski UNet implementation in the SPVNAS project by MIT HAN Lab.
Source: https://github.com/mit-han-lab/spvnas/blob/dev/torchsparsepp_backend/core/models/semantic_kitti/minkunet.py

The original work is used under its respective license, and this adapted code is intended for educational and research purposes.
"""
...
class MinkUNet(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        cs = [32/8, 32/8, 64/8, 128/8, 256/8, 256/8, 128/8, 96/8, 96/8]
